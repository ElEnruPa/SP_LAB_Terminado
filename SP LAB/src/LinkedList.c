 ...
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) [1] si paso el filtro o [0] si no paso el filtro
 * \return LinkedList* Retorna  (NULL) Error: si el puntero a la listas es NULL
...
/** \brief Realizar un cálculo con el elemento recibido y modificar alguno de sus campos si es necesario.
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) [1] si paso el filtro o [0] si no paso el filtro
 * \return LinkedList* Retorna  0 ERROR, 1 si funciono
 */
...
/** \brief Cuenta los elementos que se pasaron en la funcion pasada como parametro.
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) [1] si paso el filtro o [0] si no paso el filtro
 * \return LinkedList* Retorna  0 ERROR, nro de los elemntos q pasaron la funcion.
 */
